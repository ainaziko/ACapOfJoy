...
## About the project
Backend system for a cafetheria of desserts and drinks. All API endpoints are secured. There is a user registration and authorisation. There are two roles: Admin and client. Authentication is set up in configurations. Passwords in database are encrypted.
...
### GET (with jwt token)
<div align="center"> <img src="screenshots/getAllCustomers.png" width="90%" /> </div>
